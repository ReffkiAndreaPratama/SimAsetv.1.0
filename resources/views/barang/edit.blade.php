...
<div class="page-container">
    ...
    <div class="page-hero-mini">
        <div class="hero-mini-left">
            <div class="hero-mini-badge"><i class="fas fa-edit"></i> Edit Barang</div>
            <h1 class="hero-mini-title">
                Edit Barang &nbsp;<span class="kode-chip-white">{{ $barang->kode_barang }}</span>
            </h1>
            <p class="hero-mini-sub">{{ $barang->nama_barang }}</p>
        </div>
        <div class="hero-mini-right d-flex gap-2">
            <a href="{{ route('barang.show', $barang->kode_barang) }}" class="btn btn-light border d-flex align-items-center gap-2" style="font-size:.85rem;">
    ...
    <form method="POST" action="{{ route('barang.update', $barang->kode_barang) }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="jumlah" class="form-control @error('jumlah') is-invalid @enderror"
                                value="{{ old('jumlah', $barang->jumlah ?? 0) }}" min="0">
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="keterangan" class="form-control @error('keterangan') is-invalid @enderror"
                            rows="3" placeholder="Deskripsi atau catatan tambahan...">{{ old('keterangan', $barang->keterangan) }}</textarea>
        ...
        <div class="form-actions">
            <a href="{{ route('barang.show', $barang->kode_barang) }}" class="btn btn-light border px-4"><i class="fas fa-eye me-1"></i> Detail</a>
            <a href="{{ route('barang.index') }}" class="btn btn-light border px-4"><i class="fas fa-times me-1"></i> Batal</a>
            <button type="submit" class="btn btn-primary px-5"><i class="fas fa-save me-1"></i> Perbarui Barang</button>
        </div>
    </form>
</div>
@endsection
