...
<head>
    ...
    <title>404 — Halaman Tidak Ditemukan · SimAset RBTV</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .divider { width: 48px; height: 4px; background: linear-gradient(90deg, #2563eb, #3b82f6); border-radius: 2px; margin: 0 auto 20px; }
        .icon-wrap {
            width: 72px; height: 72px; border-radius: 50%;
            background: #EFF6FF; border: 2px solid #BFDBFE;
            display: flex; align-items: center; justify-content: center;
            margin: 0 auto 20px; font-size: 28px; color: #2563EB;
        }
...
<body>
    <div class="wrap">
        ...
        <p>Halaman yang Anda cari tidak ada atau telah dipindahkan.<br>Periksa kembali URL atau kembali ke halaman utama.</p>
        <div class="btn-row">
