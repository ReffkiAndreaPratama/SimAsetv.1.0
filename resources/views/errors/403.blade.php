...
<head>
    ...
    <title>403 — Akses Ditolak · SimAset RBTV</title>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Inter', sans-serif; }
        ...
        .divider { width: 48px; height: 4px; background: linear-gradient(90deg, #d97706, #f59e0b); border-radius: 2px; margin: 0 auto 20px; }
        .icon-wrap {
            width: 72px; height: 72px; border-radius: 50%;
            background: #FFFBEB; border: 2px solid #FDE68A;
            display: flex; align-items: center; justify-content: center;
            margin: 0 auto 20px; font-size: 28px; color: #D97706;
        }
